...
public sealed class Vaclas : SpaceShip
{
    public Vaclas(double maxTravelDistance, bool photonIsActive)
    {
        ...
        EnginesCollection = new ReadOnlyCollection<Engine>(new List<Engine>
        {
            new Engines.Entities.ImpulseEngineE(maxTravelDistance),
            new GammaJumpEngine(maxTravelDistance),
        });
