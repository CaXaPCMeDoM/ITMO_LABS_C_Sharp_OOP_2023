...
public static class WithdrawingAccountBalanceDontUpdateTest
{
    [Theory]
    ...
    public static void Test(int value)
    {
        ...
        var moqUserTable = new MoqUserTable(Id: 1, Name: "Vanya", Amount: 1, Password: "1234");
